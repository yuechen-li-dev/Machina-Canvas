...
import {
  ...
  type ArcPathResult,
  type Point2,
} from "../src/arcGeometry";
import { createMechanicalExercise354BlockoutScene } from "../scripts/create-mechanical-exercise-354-blockout";
import { createMechanicalExercise354Scene } from "../scripts/create-mechanical-exercise-354";
...
describe("MachinaCanvas arc orientation regression", () => {
  it("documents SVG/canvas y-down arc conventions in the helper source", () => {
    const source = readFileSync(join(process.cwd(), "src/arcGeometry.ts"), "utf8");
