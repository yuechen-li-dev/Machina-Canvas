...
import { serializeCanvasSpriteToml, serializeCompiledRuntimeSpriteToml } from "../src/canvasExport";
...
} from "../src/spriteSidecar";
import { compileSpriteRuntimeSidecar } from "../src/spriteGuideCompiler";
import type { ImageObject } from "../src/sceneModel";
