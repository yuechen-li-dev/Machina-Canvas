...
import { validateCanvasExportBundle } from "../src/canvasExportValidation";
...
import { getObjectBoundsSummary } from "../src/sceneSummary";
...
describe("MachinaCanvas image composite fixture", () => {
  const fixtureRoot = join(process.cwd(), "fixtures", "demo-poster.mcanvas");
