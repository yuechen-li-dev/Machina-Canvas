...
import { attachBlockoutSidecarToObject } from "../src/sceneCommands";
import type { CanvasDocument, CanvasObject, ImageObject } from "../src/sceneModel";
import { summarizeScene } from "../src/sceneSummary";
